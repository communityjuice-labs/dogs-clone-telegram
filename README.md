# Build and Launch Your Own Dogs Telegram Bot with CommunityJuice

### Dogs Clone | Telegram Mini App
...
<details>
  <summary>What is the Dogs Clone Tap-to-Earn Game?</summary>
  <p>The Dogs Clone Tap-to-Earn game is a Telegram Mini-app solution for someone who is looking for a game like Dogs. It is comprehensive package for a Telegram clicker game with marketing mechanics, designed to minimize the cost of building a Web3 community.</p> 
  <p>Examples are games like Dogs, TapSwap, NotCoin & Hamster Kombat games.</p> 
</details>
...
<details>
  <summary>What's the cost of the Dogs Clone Tap-to-Earn Bot/Game?</summary>
  <p>Our Custom Tap-to-Earn Bot/Game is offered with three pricing tiers:</p> 
  <ul>
      <li>Tier 1 - We will use the same UI/UX Design and format as our Dogs Clone model but using your brand elements such as typography, logos, and colours. Free hosting, free maintenance</li>
...
<details>
  <summary>Is the Payment Gateway included in the Dogs Clone Tap-to-Earn Bot/Game?</summary>
